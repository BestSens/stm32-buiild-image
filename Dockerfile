...
RUN wget https://github.com/Kitware/CMake/releases/download/v3.23.2/cmake-3.23.2.tar.gz -P /root/Temp && \
	tar -xzf /root/Temp/cmake-3.23.2.tar.gz -C /root/Temp && \
	/root/Temp/cmake-3.23.2/bootstrap && \
	make /root/Temp/cmake-3.23.2 && \
	make install /root/Temp/cmake-3.23.2
